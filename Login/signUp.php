...
if($category == 1)
{
    ...
    {
    	$sql = "INSERT INTO farmerregistration (fname, fusername, fpassword, fhash, fmobile, femail, faddress)
...
else
{
    ...
    {
    	$sql = "INSERT INTO buyerregistration (bname, busername, bpassword, bhash, bmobile, bemail, baddress)
    			VALUES ('$name','$user','$pass','$hash','$mobile','$email','$addr')";

        
        // INSERT INTO `buyerregistration` (`bname`, `busername`, `bpassword`, `bhash`, `bmobile`, `bemail`, `baddress`) VALUES ('Shahin Hossain', 'shahindvlpr', '12345', '12345', '01745033031', 'shahinhossen37@gmail.com', 'vatara');
    	...
    	if (mysqli_query($conn, $sql))
    	{
            ...
            http://localhost/agrimarket/Login/verify.php?email=".$email."&hash=".$hash;
